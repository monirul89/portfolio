...
$(function() {
    ...
    $.fn.elastic_grid = function(config){
        ...
        //initial filter nav
        container.html('<div class="wagwep-container"><nav id="porfolio-nav" class="clearfix"><ul id="projects-filter" class="nav nav-tabs clearfix"></ul></nav></div>');
...
* Tags to filter
***************************************************************************/
    var porfolio_filter = container.find('#projects-filter');
